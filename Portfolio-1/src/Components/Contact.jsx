        ...
        <div className=" px-6 ">
           <h2 className='text-3xl font-bold text-center mb-4'>Get In 
            ...
            <div className=" justify-center gap-12 max-w-5xl mx-auto">
                <div>
                    <form  className='space-y-6' action="https://formspree.io/f/mpwvjgjl" method='POST'>
                        <div>
                            <label htmlFor="name" className='block  text-start text-gray-300 mb-2'>Your Name</label>
                            <input required name='naem' type="text" id="name" className='w-full bg-dark-300 border border-dark-400 rounded-lg  px-4 py-3 outline-none'  />
                        </div>
                        <div>
                            <label htmlFor="email" className='block text-gray-300 mb-2 text-start'>Email Address</label>
                            <input required name='email' type="email" id="email" className='w-full bg-dark-300 border border-dark-400 rounded-lg  px-4 py-3 outline-none'  />
                        </div>
                        <div>
                            <label htmlFor="message" className='block text-gray-300 mb-2 text-start'>Your Message</label>
                            <textarea required name='message'  id="message"  className='w-full  h-40  bg-dark-300 border border-dark-400 rounded-lg  px-4 py-3 outline-none'  />
                        </div>
